...
async fn test_errcode_cache_behavior() {
    // no cache
    let case1 = E2E::new("http://example.com.gslb.com/errcode/no-cache", |_req| {
    ...
    let case2 = E2E::new("http://example.com.gslb.com/errcode/cache", |_req| {
        let body = Bytes::from_static(b"Bad Gateway");
        let mut headers = http::HeaderMap::new();
    ...
    let case3 = E2E::new("http://example.com.gslb.com/errcode/cache", wrong_hit()).await;
